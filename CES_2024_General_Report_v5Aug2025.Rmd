---
title: "CES 2024 General Report"
author: "Kier Jesse Ballar"
date: "2025-08-05"
output:
  word_document: 
  reference_docx: FEU-CES-Reference.docx
params:
  univs: ["Antipolo Institute of Technology", "Aggregate Report"]
set_subtitle: "My Title!"
subtitle: "CES 2024  \n &nbsp;`r params$set_subtitle`  \n &nbsp;  \n &nbsp;  \n &nbsp;"
---
...
```{r load data and response rates, echo = F, message = FALSE, warning = FALSE, results = 'hide'}
##### || Load Data -----
...
```{r civicaction_contactgovt, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r civicaction_blog, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r civicaction_advocacy, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 5), results = 'hide'}
...
```{r civicaction_follow, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r gender, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 4), results = 'hide'}
##### |> 1.	Demographics (Sex) -----
##### |>> Select Variables
...
```{r YearLevel, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 4), results = 'hide'}
...
```{r degree_classification, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 7), results = 'hide'}
...
```{r parentinc, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 4), results = 'hide'}
...
```{r famsupport1, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 2. Family Support -----
##### |>> Select Variables
...
```{r pinoyvalue_propriety, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 3.	Filipino values -----
##### |>> Select Variables
...
```{r goals13, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
print("##### |> 4.	Personal life goals - finalize later")
##### |> 4.	Personal life goals -----
```

```{r attcollr6, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 5.	Why go to college? -----
##### |>> Select Variables
...
```{r orglead_art, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
print("School contribution")
...
```{r nstp, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 3.	NSTP -----
##### |>> Select Variables
...
```{r nstpinf, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 4. NSTP influence -----
##### |>> Select Variables
...
```{r topics2, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 1.	Conversation Topics, FINISH AFTER SET 12 -----
print("finalize later")
##### |>> Select Variables
...
```{r internet1, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r influencepol_fam, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r teachinf1, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
##### |> 3.	Teacher Influence -----
##### |>> Select Variables
...
```{r elect_youth, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r govtpres, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r statedem, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r dem_policy, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r expperform, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r lenvsat10, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r act1, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r spent12, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r trait23, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r satpres, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r satfuture, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r feels1, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
#### |> iii.	Feelings -----
##### |>> Select Variables
...
```{r outlook_life, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r path_advocacy, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
#### |> v.	Career paths -----
##### |>> Select Variables
...
```{r ileaderorg, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r officeyouth, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r idealleader, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote_past, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote_why, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote_how, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote_infosrc, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote_comms, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r voter, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
...
```{r vote2025, include = T, message = F, echo = F, warning = FALSE, fig.showtext = TRUE, fig.dim = c(12, 8), results = 'hide'}
